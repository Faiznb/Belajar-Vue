...
export default {
  ...
  data() {
    return {
      ...
      alert_message: 'Please wait! Your song is being updated.'
    }
  },
  methods: {
    async edit(values) {
      ...
      this.alert_message = 'Please wait! Your song is being updated.'
      ...
      this.alert_message = 'Success! Your song has been updated.'
    },
    async deleteSong() {
